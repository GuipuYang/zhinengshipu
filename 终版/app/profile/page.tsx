...
export default function ProfilePage() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      onClick: () => router.push('/combinations')
    }
  ];
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-3 gap-3">
              <button
                ...
                className="flex flex-col items-center gap-2 bg-white rounded-2xl p-4 active:scale-95 transition-transform"
              >
